...
insert into product (title, price, description, image, genre_id, category_id, purchase_id) values ('Night Train to Munich', 56.47, 'Sed sagittis. Nam congue, risus semper porta volutpat, quam pede lobortis ligula, sit amet eleifend pede libero quis orci. Nullam molestie nibh in lectus.

Pellentesque at nulla. Suspendisse potenti. Cras in purus eu magna vulputate luctus.', 'http://dummyimage.com/148x100.png/cc0000/ffffff', 7, 5, 7);
insert into product (title, price, description, image, genre_id, category_id, purchase_id) values ('Brother Bear', 21.05, 'Phasellus in felis. Donec semper sapien a libero. Nam dui.

Proin leo odio, porttitor id, consequat in, consequat ut, nulla. Sed accumsan felis. Ut at dolor quis odio consequat varius.', 'http://dummyimage.com/100x100.png/ff4444/ffffff', 5, 10, 9);
insert into product (title, price, description, image, genre_id, category_id, purchase_id) values ('Comin'' at Ya!', 50.46, 'Maecenas leo odio, condimentum id, luctus nec, molestie sed, justo. Pellentesque viverra pede ac diam. Cras pellentesque volutpat dui.

Maecenas tristique, est et tempus semper, est quam pharetra magna, ac consequat metus sapien ut nunc. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Mauris viverra diam vitae quam. Suspendisse potenti.', 'http://dummyimage.com/182x100.png/ff4444/ffffff', 1, 6, 6);
insert into product (title, price, description, image, genre_id, category_id, purchase_id) values ('Nanny, The', 29.43, 'Maecenas leo odio, condimentum id, luctus nec, molestie sed, justo. Pellentesque viverra pede ac diam. Cras pellentesque volutpat dui.

Maecenas tristique, est et tempus semper, est quam pharetra magna, ac consequat metus sapien ut nunc. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Mauris viverra diam vitae quam. Suspendisse potenti.

Nullam porttitor lacus at turpis. Donec posuere metus vitae ipsum. Aliquam non mauris.', 'http://dummyimage.com/147x100.png/5fa2dd/ffffff', 1, 3, 5);
insert into product (title, price, description, image, genre_id, category_id, purchase_id) values ('St. Valentine''s Day Massacre, The', 10.27, 'Curabitur gravida nisi at nibh. In hac habitasse platea dictumst. Aliquam augue quam, sollicitudin vitae, consectetuer eget, rutrum at, lorem.', 'http://dummyimage.com/196x100.png/ff4444/ffffff', 6, 2, 8);
insert into product (title, price, description, image, genre_id, category_id, purchase_id) values ('Werewolves on Wheels', 17.61, 'Nam ultrices, libero non mattis pulvinar, nulla pede ullamcorper augue, a suscipit nulla elit ac nulla. Sed vel enim sit amet nunc viverra dapibus. Nulla suscipit ligula in lacus.', 'http://dummyimage.com/229x100.png/cc0000/ffffff', 4, 5, 2);
insert into product (title, price, description, image, genre_id, category_id, purchase_id) values ('This Is My Father', 65.47, 'Duis bibendum, felis sed interdum venenatis, turpis enim blandit mi, in porttitor pede justo eu massa. Donec dapibus. Duis at velit eu est congue elementum.
...
insert into product (title, price, description, image, genre_id, category_id, purchase_id) values ('Atlantis: The Lost Empire', 1.12, 'Curabitur gravida nisi at nibh. In hac habitasse platea dictumst. Aliquam augue quam, sollicitudin vitae, consectetuer eget, rutrum at, lorem.', 'http://dummyimage.com/131x100.png/ff4444/ffffff', 1, 3, 5);
insert into product (title, price, description, image, genre_id, category_id, purchase_id) values ('Trio', 56.0, 'Duis bibendum. Morbi non quam nec dui luctus rutrum. Nulla tellus.
...
insert into product (title, price, description, image, genre_id, category_id, purchase_id) values ('Dead Men Walk', 54.67, 'Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Vivamus vestibulum sagittis sapien. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus.

Etiam vel augue. Vestibulum rutrum rutrum neque. Aenean auctor gravida sem.', 'http://dummyimage.com/139x100.png/5fa2dd/ffffff', 10, 1, 4);
